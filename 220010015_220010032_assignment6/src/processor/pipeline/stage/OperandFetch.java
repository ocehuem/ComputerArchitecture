				...
				if (opcode <= 21 && opcode % 2 == 0) {
					...
					if (!bubbled && (next_rd == rs1 || next_rd == rs2 || 31 == rs1 || 31 == rs2)) {
						...
						if (Simulator.isDebugMode()) {
							System.out.println("[Debug] (OF) Stalled due to EX_MA_Latch, next_rd: " + next_rd
									+ ", rs1: " + rs1 + ", rs2: " + rs2 + " bubble: " + bubbled);
						}
					}
					...
					if (!bubbled && (next_rd == rs1 || next_rd == rs2 || 31 == rs1 || 31 == rs2)) {
						stall = true;
						if (Simulator.isDebugMode()) {
							System.out.println("[Debug] (OF) Stalled due to MA_RW_Latch, next_rd: " + next_rd
									+ ", rs1: " + rs1 + ", rs2: " + rs2 + " bubble: " + bubbled);
						}
					}
					...
					if (!bubbled && (next_rd == rs1 || next_rd == rs2 || 31 == rs1 || 31 == rs2)) {
						stall = true;
						if (Simulator.isDebugMode()) {
							System.out.println("[Debug] (OF) Stalled due to RW_Latch, next_rd: " + next_rd + ", rs1: "
									+ rs1 + ", rs2: " + rs2 + " bubble: " + bubbled);
						}
					}
